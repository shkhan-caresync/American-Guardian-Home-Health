...
import { CheckCircle2, AlertCircle, Lock, PhoneCall, Mail } from "lucide-react";
import EmbeddedForm from "../components/forms/EmbeddedForm";
import { FORM_URL_STAGE2, FORM_METADATA } from "../config/forms";
...
export default function Onboarding() {
  ...
  const metadata = FORM_METADATA.stage2;

  // Progress indicator
  const progressSteps = [
    { label: "Application", completed: true },
    { label: "Onboarding", completed: false, active: true },
    { label: "Medical", completed: false },
  ];
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
            ...
            >
              ...
              <p className="text-base text-slate-600 mb-6">
                This page requires a valid access token. If you received a conditional offer, 
                please use the link provided in your offer email.
              </p>
